...
public class CoolOutlineView {
    ...
    public CoolOutlineView(Composite parent) {
        ...
        titleItem.setLayoutData(GridDataFactory.fillDefaults().align(SWT.END, SWT.BEGINNING)
    ...
    private OutlineItem newItem() {
        ...
        outlineItem.setLayoutData(GridDataFactory.fillDefaults().align(SWT.END, SWT.BEGINNING).grab(true,
                false).create());
        return outlineItem;
    }
