...
public class WinDocumentStylesheet implements DocumentStylesheet {
	...
	public WinDocumentStylesheet(Display display) {
        projectFont = new Font(display, "Georgia", 15, SWT.NONE);
		textFont = new Font(display, "Gill Sans", 11, 0);
		taskFont = new Font(display, "Gill Sans", 11, 0);
		tagFont = new Font(display, "Gill Sans", 11, 0);
