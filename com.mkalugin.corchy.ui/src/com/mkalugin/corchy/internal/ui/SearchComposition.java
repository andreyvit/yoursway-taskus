...
public class SearchComposition {
    ...
    private void createControls(Composite parent) {
        ...
        searchNavigationComposite.setLayoutData(GridDataFactory.swtDefaults().align(SWT.FILL, SWT.CENTER)
        ...
        searchField.setLayoutData(GridDataFactory.defaultsFor(searchField).align(SWT.END, SWT.CENTER).grab(
                false, false).indent(4, 0).create());
        ...
        GridLayoutFactory.swtDefaults().numColumns(2).margins(0, 0).spacing(8, 0).generateLayout(composite);
    }
    ...
    private void createSearchNavigationControls(Composite composite) {
        ...
        prevButton.setLayoutData(GridDataFactory.defaultsFor(prevButton).align(SWT.END, SWT.CENTER).hint(32,
                SWT.DEFAULT).create());
        ...
        nextButton.setLayoutData(GridDataFactory.defaultsFor(nextButton).align(SWT.END, SWT.CENTER).hint(32,
                SWT.DEFAULT).create());
